...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero__bg { position: relative; background: url('https://anoukkievit.nl/wp-content/uploads/2026/06/Anouk-Kievit_Kramer-Fotografeert-0869.jpg') center top / cover no-repeat; opacity: 0; transition: opacity .5s; min-height: 92vh; }
    ...
    @media (max-width:780px) { .hero { grid-template-columns: 1fr; } .hero__bg { min-height: 65vw; order: -1; background-position: center top; } .hero__content { padding: 56px 32px; } }
    ...
    .final-cta__bg { position: absolute; inset: 0; background: url('https://anoukkievit.nl/wp-content/uploads/2026/06/Anouk-Kievit_Kramer-Fotografeert-0744.jpg') center 5% / cover no-repeat; }
  ...
  <div class="w">
    <div class="voor-wie__inner">
      ...
      <ul class="voor-wie__list">
        <li>Je werkt hard, doet je best, maar ergens is er iets wat je niet los krijgt. En je weet al lang dat het niet aan de strategie ligt.</li>
        <li>Je hoofd staat nooit echt stil. Ook niet als je 'ontspant'. Er is altijd die stem die commentaar heeft.</li>
        <li>Je hebt coaches gehad, boeken gelezen, trajecten gevolgd. En toch zit er iets wat je niet verschoven krijgt.</li>
        <li>Je voelt dat je jezelf inhoudt. In wat je zegt, in wat je vraagt, in hoe je jezelf laat zien. Maar je weet niet precies waarom.</li>
        <li>Je bent niet op zoek naar nog meer inzichten. Je wil dat er iets werkelijk verschuift. Nu.</li>
      </ul>
    </div>
  </div>
</section>
  ...
  <div class="w">
    ...
    <div class="pricing__cards">
      <div class="price-card">
        ...
        <a href="#contact" class="btn btn--outline-dark">Ik boek de sessie</a>
      </div>
  ...
  <div class="w">
    <div class="about__inner">
      ...
      <div>
        ...
        <p>Ik weet hoe het is om een gedachte als de waarheid te leven. Jarenlang leefde ik vanuit "als ik aankom, gaat het mis." Dat was geen feit. Maar het stuurde alles: wat ik at, hoe ik mezelf zag, wat ik toeliet.</p>
        <p>Pas toen ik die gedachte durfde onderzoeken, in plaats van erin te geloven, veranderde er iets wat ik niet meer terug wil draaien. Niet door er harder aan te werken. Maar door te stoppen met hem als de waarheid te behandelen.</p>
        <div class="about__pullquote">
          Ik ga niemand vertellen wat ze moeten doen<br>voordat we begrijpen waarom ze doen wat ze doen.
        </div>
        <p>Sindsdien stel ik mensen één vraag: is het eigenlijk wel waar? Want hoeveel van wat jou tegenhoudt is echt de waarheid?</p>
...
<section class="final-cta" id="contact">
  ...
  <div class="final-cta__content">
    <h2>Je gedachten zijn geen feiten.<br>En dat is <em>bevrijdend.</em></h2>
    <p>Na één sessie kijk je nooit meer hetzelfde naar de stem in je hoofd.<br>Dat is het begin van echte vrijheid.</p>
