...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero__bg { position: absolute; inset: 0; background: url('images/anouk-bogen.jpg') center center / cover no-repeat; background-color: #B86040; }
    .hero__bg::after { content: ''; position: absolute; inset: 0; background: linear-gradient(to bottom, rgba(20,15,10,.45) 0%, rgba(20,15,10,.55) 100%); }
      ...
      <div class="pijn__text">
        ...
        <ul class="pijn__list">
          ...
          <li>
            ...
            <div class="pijn__list-body">Systemen, structuur, aanbod aangescherpt. De buitenkant klopte. Maar vanbinnen voelde je nog steeds die rem — en die coach kon hem niet vinden.</div>
          </li>
          <li>
...
<section class="verlangen" id="verlangen">
  <div class="w">
    <div class="verlangen__header">
      ...
      <p>Je hoeft het niet te verdienen. Je hoeft er niet eerst klaar voor te zijn. Dit is wat je al heel lang wil — en je bent er klaar voor om het eindelijk te krijgen.</p>
    </div>
