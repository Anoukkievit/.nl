...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero__bg { position: relative; background: url('https://anoukkievit.nl/wp-content/uploads/2026/06/Anouk-Kievit_Kramer-Fotografeert-0869.jpg') center 10% / cover no-repeat; opacity: 0; transition: opacity .5s; min-height: 92vh; }
    ...
    @media (max-width:780px) { .hero { grid-template-columns: 1fr; } .hero__bg { min-height: 65vw; order: -1; background-position: center 12%; } .hero__content { padding: 56px 32px; } }
    ...
    .final-cta__bg { position: absolute; inset: 0; background: url('https://anoukkievit.nl/wp-content/uploads/2026/06/Anouk-Kievit_Kramer-Fotografeert-0744.jpg') center 25% / cover no-repeat; }
