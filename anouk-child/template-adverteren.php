...
<nav class="nav">
  ...
  <ul class="nav__links">
    <li><a href="#aanbod">Bekijk het aanbod</a></li>
...
<!-- HERO -->
<section class="hero">
  <span class="hero__eye">Meta Ads Strateeg &amp; Mentor</span>
  ...
  <div class="hero__ctas">
    <a href="#aanbod" class="btn btn--dark">Bekijk het aanbod</a>
    ...
    <div class="photo-cards">
      ...
      <div>
        <div class="pcard">
          ...
          />
          <div class="pcard__label">Gratis Masterclass</div>
        </div>
    ...
    <div class="about__inner">
      <div>
        ...
        <div class="about__body">
          ...
          <p>Dat kan anders.</p>
          <p>Daarom besloot ik mijn kennis niet langer alleen uit te voeren, maar ondernemers te leren hoe ze zelf winstgevend kunnen adverteren. De eerste editie van mijn training werd direct door <strong>221 ondernemers</strong> gekocht.</p>
