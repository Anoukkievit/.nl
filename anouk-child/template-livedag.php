...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    h2 { font-family: 'DM Serif Display', serif; font-size: clamp(34px, 5.5vw, 64px); font-weight: 500; line-height: 1.15; color: var(--text); margin-bottom: 32px; }
    ...
    .hero__h1 { font-family: 'DM Serif Display', serif; font-size: clamp(38px, 6vw, 80px); font-weight: 500; line-height: 1.1; color: #fff; margin-bottom: 32px; }
    .hero__h1 em { font-style: italic; color: var(--pink); }
    .hero__sub { font-family: 'DM Serif Display', serif; font-size: clamp(17px, 1.8vw, 22px); font-style: italic; font-weight: 400; color: rgba(255,255,255,.85); max-width: 520px; margin: 0 0 52px; line-height: 1.55; }
    ...
    .strip__val { font-family: 'DM Serif Display', serif; font-size: 19px; color: var(--text); }
    ...
    .pijn__intro { font-family: 'DM Serif Display', serif; font-size: clamp(17px, 2vw, 21px); font-style: italic; font-weight: 400; color: var(--soft); line-height: 1.6; margin-bottom: 40px; }
    ...
    .pijn__list-title { font-family: 'DM Serif Display', serif; font-size: clamp(17px, 1.8vw, 20px); font-weight: 600; color: var(--text); margin-bottom: 6px; }
    .pijn__list-body { font-size: 16px; color: var(--soft); line-height: 1.75; }
    .pijn__close { margin-top: 40px; font-family: 'DM Serif Display', serif; font-size: clamp(20px, 2.5vw, 26px); font-style: italic; font-weight: 300; color: var(--text); line-height: 1.5; }
    ...
    .band__text { font-family: 'DM Serif Display', serif; font-size: clamp(24px, 4vw, 48px); font-weight: 400; font-style: italic; line-height: 1.3; max-width: 820px; margin: 0 auto 16px; }
    ...
    .verlangen__card-q { font-family: 'DM Serif Display', serif; font-size: clamp(18px, 2vw, 22px); font-style: italic; font-weight: 400; color: var(--text); line-height: 1.4; margin-bottom: 14px; }
    ...
    .watals__copy h3 { font-family: 'DM Serif Display', serif; font-size: clamp(22px, 2.5vw, 32px); font-weight: 500; line-height: 1.2; color: var(--text); margin-bottom: 16px; }
    ...
    .versie__quote { margin: 28px 0; font-family: 'DM Serif Display', serif; font-size: 20px; font-style: italic; color: rgba(255,255,255,.9); line-height: 1.45; }
    ...
    .price-card__name { font-family: 'DM Serif Display', serif; font-size: 30px; font-weight: 500; color: var(--text); margin-bottom: 8px; }
    ...
    .price-card__price { font-family: 'DM Serif Display', serif; font-size: 56px; font-weight: 400; color: var(--coral); line-height: 1; margin: 0 0 4px; }
    ...
    .about__pullquote { margin: 28px 0; font-family: 'DM Serif Display', serif; font-size: 20px; font-style: italic; color: var(--text); line-height: 1.45; }
    ...
    .faq__q { font-family: 'DM Serif Display', serif; font-size: 19px; color: var(--text); margin-bottom: 8px; }
    ...
    .final-cta__content h2 { font-family: 'DM Serif Display', serif; font-size: clamp(36px, 6vw, 72px); font-weight: 500; line-height: 1.05; color: #fff; margin-bottom: 24px; }
    ...
    .inzicht__body { font-family: 'DM Serif Display', serif; font-size: clamp(20px, 2.5vw, 28px); font-weight: 400; line-height: 1.65; color: var(--text); margin-bottom: 32px; }
    .inzicht__body em { font-style: italic; color: var(--coral); }
    .inzicht__vraag { font-family: 'DM Serif Display', serif; font-size: clamp(26px, 3.5vw, 44px); font-style: italic; font-weight: 400; color: var(--text); line-height: 1.3; padding-top: 40px; margin-top: 16px; }
